...
/**
 * CurrentToRand1Mutator is a class implementing DE/current-to-rand/1 mutation
 ...
 * @since 1.0
 */
public class CurrentToRand1Mutator implements Mutator {
     ...
     */
    public CurrentToRand1Mutator(Execution exe) {
        this.exe = exe;
    }
    ...
    public Individual mutateIndividual(Population p, Individual X, Individual... individuals) {
        ...
        for (int k = 0; k < D; k++) {
            V.setGene(k, x[k] + F * (r1[k] - x[k]) + F * (r2[k] - r3[k]));
        }
